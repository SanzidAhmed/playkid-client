    ...
    return (
        <div className="carousel w-full h-[800px]">
            ...
            <div id="slide2" className="carousel-item relative w-full">
                ...
                <div className="absolute  transform pl-10 pt-10  p-20 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] h-[800px] md:w-1/3">
                    <h4 className='text-3xl text-white mb-3'>Creative toys</h4>
                    <h1 className='text-5xl text-white mb-3 '>A new world of play</h1>
                    <h1 className='text-xl text-white mb-12 '>Toys bring happiness, creativity, and joy to kids, making a memorable tagline crucial for attracting loyal customers.</h1>
            ...
            <div id="slide3" className="carousel-item relative w-full">
                ...
                <div className="absolute  transform pl-10 pt-10  p-20 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] h-[800px] md:w-1/3">
                    <h4 className='text-3xl text-white mb-3'>Toy shares love</h4>
                    <h1 className='text-5xl text-white mb-3'>A new world of play</h1>
                    <h1 className='text-xl text-white mb-12 '>The best place for your kids</h1>
                    <button className="btn btn-warning rounded-3xl bg-white border-white">buy now</button>
                </div>
                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    <a href="#slide2" className="btn btn-circle">❮</a>
            ...
            <div id="slide4" className="carousel-item relative w-full">
                ...
                <div className="absolute  transform pl-10 pt-10  p-20 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] h-[800px] md:w-1/3">
                    <h4 className='text-3xl text-white mb-3'>Discover the new Today</h4>
                    <h1 className='text-5xl text-white mb-3'>A new world of play</h1>
                    <h1 className='text-xl text-white mb-24 md:mb-12'>the best Way to Adorn Playing Moments</h1>
                    <button className="btn btn-warning rounded-3xl bg-white border-white">buy now</button>
                </div>
                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    <a href="#slide3" className="btn btn-circle">❮</a>
